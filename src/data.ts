/*
 * Static word pools used as fallback before the main word list loads from /words.txt.
 * Two languages (English & Hindi) × three difficulty levels (easy, medium, hard).
 */

// Short common English words (1-4 chars)
const enEasy = [
...
// Intermediate-length English words (5-7 chars)
const enMedium = [
...
// Long, complex English words (8+ chars)
const enHard = [
...
// Complex multi-syllable Hindi words
const hiHard = [
...
/*
 * Generates random space-separated words for the typing test.
 * Picks from the appropriate language × difficulty pool.
 */
